...
class Disposable_Email_Blocker_Ninja_Forms
{
	...
	{
		if ( defined( 'DISPOSABLE_EMAIL_BLOCKER_NINJA_FORMS_VERSION' ) )
		{
			$this->version = DISPOSABLE_EMAIL_BLOCKER_NINJA_FORMS_VERSION;
		}
		else
		{
			$this->version = '2.0.0';
	 ...
	 * - Disposable_Email_Blocker_Ninja_Forms_i18n. Defines internationalization functionality.
	...
	private function load_dependencies()
	{
		 ...
		 * core plugin.
		 */
		require_once DISPOSABLE_EMAIL_BLOCKER_NINJA_FORMS_PLUGIN_PATH . 'includes/class-plugin-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once DISPOSABLE_EMAIL_BLOCKER_NINJA_FORMS_PLUGIN_PATH . 'includes/class-plugin-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once DISPOSABLE_EMAIL_BLOCKER_NINJA_FORMS_PLUGIN_PATH . 'admin/class-plugin-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once DISPOSABLE_EMAIL_BLOCKER_NINJA_FORMS_PLUGIN_PATH . 'public/class-plugin-public.php';
	 ...
	 *
	 * Uses the Disposable_Email_Blocker_Ninja_Forms_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    2.0.0
	 * @access   private
	...
	{
		$plugin_i18n = new Disposable_Email_Blocker_Ninja_Forms_i18n();
