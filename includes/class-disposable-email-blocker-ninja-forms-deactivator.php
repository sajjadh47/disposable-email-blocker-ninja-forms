<?php
/**
 * This file contains the definition of the Disposable_Email_Blocker_Ninja_Forms_Deactivator class, which
 ...
 * @since    2.0.0
 */
class Disposable_Email_Blocker_Ninja_Forms_Deactivator {
	/**
	 * Deactivation hook.
	 *
